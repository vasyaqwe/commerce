...
const toggleVariants = cva(
   "inline-flex items-center justify-center font-medium transition-colors disabled:pointer-events-none disabled:opacity-70 focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-accent",
   {
      variants: {
         variant: {
            default:
            ...
            outline:
               "border bg-background text-foreground/75 shadow-xs transition-all data-[state=on]:brightness-[98%] hover:brightness-[98%]",
         },
         size: {
