...
export function Header(props: ComponentProps<"header">) {
   ...
   return (
      <header
         className="sticky top-0 z-[2] flex items-center border-border border-b bg-background py-1.5 md:py-3"
         {...props}
      >
         <div className="container flex items-center">
            <div className="flex items-center gap-8 md:min-w-[300px]">
               ...
               <nav
                  ...
                  className={cn(
                     "max-md:data-[state=closed]:reveal max-md:data-[state=open]:hide duration-700 max-md:fixed max-md:inset-0 max-md:top-[69px] max-md:h-[calc(100svh-69px)] max-md:overflow-y-auto max-md:bg-popover max-md:p-3 max-md:text-popover-foreground",
                  )}
               >
